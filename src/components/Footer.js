                ...
                <div className="row justify-content-center">             
                    ...
                    <div className="col-7 col-sm-5">
                        ...
                        <address>
                            ...
                            HONG KONG<br/>
                            <i className="fas fa-phone fa-lg"></i> +852 1234 5678<br/>
                            <i className="fas fa-fax fa-lg"></i> +852 8765 4321<br/>
                            <i className="fas fa-envelope fa-lg"></i> <a href="mailto:confusion@food.net">confusion@food.net</a>
                        </address>
                    </div>
